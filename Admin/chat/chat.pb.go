...
var file_chat_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x6e, 0x73, 0x61, 0x6a, 0x65, 0x32, 0x70, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x30, 0x0a, 0x0e, 0x52, 0x65, 0x63, 0x69, 0x62, 0x69,
	0x72, 0x44, 0x65, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x12, 0x0d, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e,
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x0d, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x00, 0x12, 0x2f, 0x0a, 0x0d, 0x42, 0x75, 0x73, 0x63,
	0x61, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x6f, 0x12, 0x0d, 0x2e, 0x63, 0x68, 0x61, 0x74,
...
var file_chat_proto_depIdxs = []int32{
	...
	0, // 1: chat.ChatService.BuscaRegistro:input_type -> chat.Message
	0, // 2: chat.ChatService.RecibirDeAdmin:output_type -> chat.Message
	0, // 3: chat.ChatService.BuscaRegistro:output_type -> chat.Message
...
func (c *chatServiceClient) BuscaRegistro(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/chat.ChatService/BuscaRegistro", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ChatService_BuscaRegistro_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Message)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServiceServer).BuscaRegistro(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.ChatService/BuscaRegistro",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).BuscaRegistro(ctx, req.(*Message))
	}
	return interceptor(ctx, in, info, handler)
}
